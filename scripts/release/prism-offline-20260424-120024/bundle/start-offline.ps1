...
[System.IO.File]::WriteAllText($backendLog, "", [System.Text.Encoding]::UTF8)
[System.IO.File]::WriteAllText($frontendLog, "", [System.Text.Encoding]::UTF8)
$backendCmd = "`$env:PRISM_CONFIG_PATH='$resolvedConfig'; `$env:SERVER_ADDR='$backendAddr'; `$env:PRISM_STATIC_DIR=''; & '$backendExe' *>> '$backendLog'"
...
$frontendCmd = "`$env:PRISM_FRONTEND_DIST='" + (Join-Path $root "frontend\dist") + "'; `$env:BACKEND_TARGET='http://127.0.0.1:$backendPort'; `$env:FRONTEND_HOST='127.0.0.1'; `$env:FRONTEND_PORT='$frontendPortFinal'; & '$nodeCmd' '$frontendServer' *>> '$frontendLog'"
